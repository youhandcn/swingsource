...
public class ApplicationFrame extends JFrame {
	...
	private void addLayersControl() {
		...
		JComboBox layerSelection = new JComboBox(new String[] { "Layer 0",
		...
		layerSelection.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				layeredPane
						.setLayer(loupe, (Integer) (JLayeredPane.DEFAULT_LAYER
								+ layerId * 2 + 1));
			}
		});
	...
	private void createLoupe() {
		loupe = new Magnifier(layeredPane);
		layeredPane.add(loupe, (Integer) (JLayeredPane.DEFAULT_LAYER + 1));
	}
}
