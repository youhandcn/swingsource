 ...
 * <code>LINE_START</code>, and <code>LINE_END</code>. In a container
 * whose <code>ComponentOrientation</code> is set to
 ...
 * and <code>LINE_END</code> respectively. For consistency with the relative
 ...
 * <code>NORTH</code> and <code>PAGE_START</code> constants in a container
 * whose orientation is <code>LEFT_TO_RIGHT</code>, only the
 * <code>PAGE_START</code> will be layed out.
 * <p>
 * NOTE: Currently (in the Java 2 platform v1.2), <code>BorderLayout</code>
 * does not support vertical orientations. The <code>isVertical</code> setting
 * on the container's <code>ComponentOrientation</code> is not respected.
 * <p>
...
public class BorderLayout implements LayoutManager2, Serializable {
    ...
    public void addLayoutComponent(String name, Component comp) {
        synchronized (comp.getTreeLock()) {
            ...
            if ("Center".equals(name)) {
                ...
                throw new IllegalArgumentException("cannot add to layout: unknown constraint: "
                        + name);
            }
        }
    }
     ...
     * @exception IllegalArgumentException
     *                if the constraint object is not one of the nine specified
     *                constants
     ...
     * <code>PAGE_END</code>, <code>LINE_START</code>, and
     * <code>LINE_END</code> take precedence over components added with the
     * explicit constraints <code>NORTH</code>, <code>SOUTH</code>,
     * <code>WEST</code>, and <code>EAST</code>. The
     * <code>Container</code>'s component orientation is used to determine
     * the location of components added with <code>LINE_START</code> and
     * <code>LINE_END</code>.
     * 
     * @param constraints
     ...
     *         the location is empty
     * @exception IllegalArgumentException
     *                if the constraint object is not one of the five specified
     *                constants
