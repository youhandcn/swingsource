...
class AquaLayoutStyle extends LayoutStyle {
	...
	/**
	 * The containerGapDefinitions array defines the preferred insets (child
	 * gaps) of a parent container towards one of its child components.
	 * 
	 * Note: As of now, we do not yet specify the preferred gap from a child to
	 * its parent. Therefore we may not be able to treat all special cases.
	 * 
	 * This array is used to initialize the containerGaps HashMap.
	 * 
	 * The array has the following structure, which is supposed to be a a
	 * compromise between legibility and code size.
	 * containerGapDefinitions[0..n] = preferred insets for some parent UI's
	 * containerGapDefinitions[][0..m-3] = name of parent UI, optionally
	 * followed by a full stop and a style name containerGapDefinitions[][m-2] =
	 * mini insets containerGapDefinitions[][m-1] = small insets
	...
	// Format:
			...
			{ "TabbedPaneUI", new Insets(6, 10, 10, 10),
					new Insets(6, 10, 10, 12), new Insets(12, 20, 20, 20) },
			...
			// note for regular size: leave only 12 pixel at top if tabbed pane
			// UI
			{ "RootPaneUI", new Insets(8, 10, 10, 10),
					new Insets(8, 10, 10, 12), new Insets(14, 20, 20, 20) },

			// These child gaps are used for all other components
			{ "default", new Insets(8, 10, 10, 10), new Insets(8, 10, 10, 12),
					new Insets(14, 20, 20, 20) }, };

	/**
	 * The relatedGapDefinitions table defines the preferred gaps of one party
	 * of two related components.
	 * 
	 * The effective preferred gap is the maximum of the preferred gaps of both
	 * parties.
	 * 
	 ...
	 * The array has the following structure, which is supposed to be a a
	 * compromise between legibility and code size.
	 * containerGapDefinitions[0..n] = preferred gaps for a party of a two
	 * related UI's containerGapDefinitions[][0..m-3] = name of UI optionally
	 * followed by a full stop and a style name containerGapDefinitions[][m-2] =
	 * mini insets containerGapDefinitions[][m-1] = small insets
	 * containerGapDefinitions[][m] = regular insets
	 */
	private final static Object[][] relatedGapDefinitions = {
			...
			{ "ButtonUI.metal", "ToggleButtonUI.metal", new Insets(8, 8, 8, 8),
					new Insets(8, 8, 8, 8), new Insets(12, 12, 12, 12) },
			...
			{ "ButtonUI.bevel", "ButtonUI.toggle", "ButtonUI.square",
					"ToggleButtonUI", "ToggleButtonUI.bevel",
					"ToggleButtonUI.square", "ToggleButtonUI.toggle",
			...
			{ "ButtonUI.bevel.largeIcon", "ToggleButtonUI.bevel.largeIcon",
					new Insets(8, 8, 8, 8), new Insets(8, 8, 8, 8),
					new Insets(8, 8, 8, 8) },
			...
			{ "ButtonUI.icon", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) },
			{ "ButtonUI.icon.largeIcon", new Insets(8, 8, 8, 8),
					new Insets(8, 8, 8, 8), new Insets(8, 8, 8, 8) },
			...
			{ "ButtonUI.help", new Insets(12, 12, 12, 12),
					new Insets(12, 12, 12, 12), new Insets(12, 12, 12, 12) },
			...
			{ "ButtonUI.toggleCenter", "ToggleButtonUI.toggleCenter",
					new Insets(8, 0, 8, 0), new Insets(10, 0, 10, 0),
					new Insets(12, 0, 12, 0) },
			{ "ButtonUI.toggleEast", "ToggleButtonUI.toggleEast",
					new Insets(8, 0, 8, 8), new Insets(10, 0, 10, 10),
					new Insets(12, 0, 12, 12) },
			{ "ButtonUI.toggleWest", "ToggleButtonUI.toggleWest",
					new Insets(8, 8, 8, 0), new Insets(10, 10, 10, 0),
					new Insets(12, 12, 12, 0) },
			...
			// { "CheckBoxUI", new Insets(7, 5, 7, 5), new Insets(8, 6, 8, 6),
			// new Insets(8, 8, 8, 8) },
			{ "CheckBoxUI", new Insets(6, 5, 6, 5), new Insets(7, 6, 7, 6),
					new Insets(7, 6, 7, 6) },

			// http://developer.apple.com/documentation/UserExperience/Conceptual/OSXHIGuidelines/XHIGControls/chapter_18_section_3.html#//apple_ref/doc/uid/20000957-TP30000359-TPXREF198
			{ "ComboBoxUI.editable", new Insets(8, 5, 8, 5),
					new Insets(10, 6, 10, 6), new Insets(12, 8, 12, 8) },
			{ "ComboBoxUI.uneditable", new Insets(6, 5, 6, 5),
					new Insets(8, 6, 8, 6), new Insets(10, 8, 10, 8) },
			// There is no spacing given for labels.
			// This comes from playing with IB.
			// We use the values here, which is the minimum of the spacing of
			// all
			// other components.
			{ "LabelUI", new Insets(8, 8, 8, 8), new Insets(8, 8, 8, 8),
					new Insets(8, 8, 8, 8) },

			// ? spacing not given
			{ "ListUI", new Insets(5, 5, 5, 5), new Insets(6, 6, 6, 6),
					new Insets(6, 6, 6, 6) },

			// ? spacing not given
			{ "PanelUI", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) },
			...
			// ? spacing not given
			{ "ProgressBarUI", new Insets(8, 8, 8, 8),
			...
			{ "RadioButtonUI", new Insets(5, 5, 5, 5), new Insets(6, 6, 6, 6),
					new Insets(6, 6, 6, 6) },
			...
			{ "ScrollPaneUI", new Insets(6, 8, 6, 8), new Insets(6, 8, 6, 8),
			...
			{ "SeparatorUI", new Insets(8, 8, 8, 8),
					new Insets(10, 10, 10, 10), new Insets(12, 12, 12, 12) },
			...
			{ "SliderUI.horizontal", new Insets(8, 8, 8, 8),
					new Insets(10, 10, 10, 10), new Insets(12, 12, 12, 12) },
			{ "SliderUI.vertical", new Insets(8, 8, 8, 8),
					new Insets(10, 10, 10, 10), new Insets(12, 12, 12, 12) },
			...
			{ "SpinnerUI", new Insets(6, 8, 6, 8), new Insets(6, 8, 6, 8),
					new Insets(8, 10, 8, 10) },
			...
			// ? spacing not given
			{ "SplitPaneUI", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) },
			...
			// ? spacing not given
			{ "TabbedPaneUI", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) },
			{ "TableUI", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) },
			// ? spacing not given
			...
			// ? spacing not given
			{ "TreeUI", new Insets(0, 0, 0, 0), new Insets(0, 0, 0, 0),
					new Insets(0, 0, 0, 0) }, };
	private final static Object[][] unrelatedGapDefinitions = {
			// UI, mini, small, regular
			{ "ButtonUI.help", new Insets(24, 24, 24, 24),
					new Insets(24, 24, 24, 24), new Insets(24, 24, 24, 24) },
			{ "default", new Insets(10, 10, 10, 10),
					new Insets(12, 12, 12, 12), new Insets(14, 14, 14, 14) }, };
	/**
	 * The indentGapDefinitions table defines the preferred indentation for
	 * components that are indented after the specified component.
	 * 
	 * This array is used to initialize the indentGaps HashMap.
	 * 
	 * The array has the following structure, which is supposed to be a a
	 * compromise between legibility and code size. indentGapDefinitions[0..n] =
	 * preferred gaps for a party of a two related UI's
	 * indentGapDefinitions[][0..m-3] = name of UI optionally followed by a full
	 * stop and a style name indentGapDefinitions[][m-2] = mini insets
	 * indentGapDefinitions[][m-1] = small insets indentGapDefinitions[][m] =
	 * regular insets
	 */
	private final static Object[][] indentGapDefinitions = {
			// UI, mini, small, regular

			// The Aqua L&F does not scale button images of check boxes and
			// radio
			// buttons. Therefore we use to the same horizontal indents for all
			// sizes.
			{ "CheckBoxUI", "RadioButtonUI", new Insets(16, 24, 16, 24),
					new Insets(20, 24, 20, 24), new Insets(24, 24, 24, 24) },

			{ "default", new Insets(16, 16, 16, 16),
					new Insets(20, 20, 20, 20), new Insets(24, 24, 24, 24) }, };
	/**
	 * The visualMarginDefinition table defines the visually perceived margin of
	 * the components.
	 * 
	 ...
	 * The array has the following structure, which is supposed to be a a
	 * compromise between legibility and code size.
	 * visualMarginDefinitions[0..n] = preferred gaps for a party of a two
	 * related UI's visualMarginDefinitions[][0..m-1] = name of UI optionally
	 * followed by a full stop and a style name containerGapDefinitions[][m] =
	 * visual margins
	 */
	private final static Object[][] visualMarginDefinitions = {
			// UI, regular
			{ "ButtonUI", "ButtonUI.text", "ToggleButtonUI",
					"ToggleButtonUI.text", new Insets(5, 3, 3, 3) },
			{ "ButtonUI.icon", "ToggleButtonUI.icon", new Insets(5, 2, 3, 2) },
			{ "ButtonUI.toolbar", "ToggleButtonUI.toolbar",
					new Insets(0, 0, 0, 0) },
			...
			{ "ProgressBarUI", "ProgressBarUI.horizontal",
					new Insets(0, 2, 4, 2) },
	...
	/**
	 * The relatedGaps map defines the preferred gaps of one party of two
	 * related components.
	 */
	private final static Map<String, ComponentInsets> RELATED_GAPS = createInsetsMap(relatedGapDefinitions);
	/**
	 * The unrelatedGaps map defines the preferred gaps of one party of two
	 * unrelated components.
	 */
	private final static Map<String, ComponentInsets> UNRELATED_GAPS = createInsetsMap(unrelatedGapDefinitions);
	/**
	 * The containerGaps map defines the preferred insets (child gaps) of a
	 * parent component towards one of its children.
	 */
	private final static Map<String, ComponentInsets> CONTAINER_GAPS = createInsetsMap(containerGapDefinitions);
	/**
	 * The indentGaps map defines the preferred indentation for components that
	 * are indented after the specified component.
	 */
	private final static Map<String, ComponentInsets> INDENT_GAPS = createInsetsMap(indentGapDefinitions);
	/**
	 * The visualMargins map defines the preferred indentation for components
	 * that are indented after the specified component.
	 */
	 ...
	 * <p>
	 * The key for the map is the name of the UI, for example, ButtonUI, with a
	 * value of ComponentInsets. Each ComponentInsets may have sub styles.
	 */
	// private static Map<String,ComponentInsets> createInsetsMap(Object[][]
	// definitions) {
	private static Map<String, ComponentInsets> createInsetsMap(
			Object[][] definitions) {
		Map<String, ComponentInsets> map = new HashMap<String, ComponentInsets>();
		for (int i = 0; i < definitions.length; i++) {
			...
			for (int j = 0; j < keys; j++) {
				...
				if (subindex == -1) {
					ComponentInsets componentInsets = (ComponentInsets) map
							.get(key);
					...
					componentInsets.addSubinsets(subkey, new ComponentInsets(
							values));
				}
			}
		}
	...
	public static void main(String[] args) {
		...
		int gap = style.getPreferredGap(button, button2, LayoutStyle.RELATED,
				SwingConstants.EAST, null);
		System.err.println("gap= " + gap);
		button.putClientProperty("JButton.buttonType", "square");
		button2.putClientProperty("JButton.buttonType", "square");
		gap = style.getPreferredGap(button, button2, LayoutStyle.RELATED,
				SwingConstants.EAST, null);
		System.err.println("gap= " + gap);
	}
	 ...
	 * value indicates the distance to place <code>component2</code> relative
	 * to <code>component1</code>. For example, the following returns the
	 * amount of space to place between <code>component2</code> and
	 * <code>component1</code> when <code>component2</code> is placed
	 * vertically above <code>component1</code>:
	 * 
	 * <pre>
	 ...
	 * requested. It can be one of the following values: <table>
	 * <tr>
	 ...
	 * relative to a JLabel use <code>INDENT</code>. This is only useful for
	 * the horizontal axis. </table>
	 * <p>
	 ...
	 * and position of <code>component2</code> or <code>component1</code>.
	 * The return value may take into consideration various properties of the
	 ...
	 *               <code>component2</code> is
	 *            being placed relative to
	 * @param component2
	 ...
	 *             <code>SwingConstants.SOUTH</code>,
	 *             <code>SwingConstants.EAST</code> or
	 *             <code>SwingConstants.WEST</code>; <code>type</code> not
	 *             one of <code>INDENT</code>, <code>RELATED</code> or
	...
	private Insets getPreferredGap(JComponent component, int type, int sizeStyle) {
		Map<String, ComponentInsets> gapMap;
		...
		if (uid == "ButtonUI" || uid == "ToggleButtonUI") {
			...
			style = (((JProgressBar) component).getOrientation() == JProgressBar.HORIZONTAL) ? "horizontal"
					: "vertical";
		} else if (uid == "SliderUI") {
			style = (((JSlider) component).getOrientation() == JProgressBar.HORIZONTAL) ? "horizontal"
					: "vertical";
			...
			style = ((JComboBox) component).isEditable() ? "editable"
					: "uneditable";
		}
	 ...
	 *            <code>SwingConstants.WEST</code>
	 * @param parent
	 *            the parent of <code>component</code>; this may differ from
	 *            the actual parent and may be null
	 ...
	 *             <code>SwingConstants.SOUTH</code>,
	 *             <code>SwingConstants.EAST</code> or
	 *             <code>SwingConstants.WEST</code>; or
	...
	private Insets getInsets(Map<String, ComponentInsets> gapMap, String uid,
			String style, int sizeStyle) {
		if (uid == null) {
			uid = "default";
		}
	 ...
	 * For example, a Button may not a set of insets, as well as insets when it
	 * has a style of metal.
	 */
	private static class ComponentInsets {
		...
		void addSubinsets(String subkey, ComponentInsets subinsets) {
			if (children == null) {
				children = new HashMap<String, ComponentInsets>(5);
			}
			children.put(subkey, subinsets);
		}

		ComponentInsets getSubinsets(String subkey) {
			return (children == null) ? null : (ComponentInsets) children
					.get(subkey);
		}
	}
}
