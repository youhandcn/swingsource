 ...
 * during layout. LayoutStyle can be obtained for two components, or for a
 * component relative to an edge of a parent container. The amount of space can
 * vary depending upon whether or not the components are logically grouped
 * together (<code>RELATED</code>).
 * <p>
 * This class is primarily useful for JREs prior to 1.6. In 1.6 API for this was
 * added to Swing. When run on a JRE of 1.6 or greater this will call into the
 * appropriate methods in Swing.
 * 
...
public class LayoutStyle {
	...
	/**
	 * Possible argument to getPreferredGap. Used to indicate the distance to
	 * indent a component is being requested. To visually indicate a set of
	 * related components they will often times be horizontally indented, the
	 * <code>INDENT</code> constant for this. For example, to indent a check
	 * box relative to a label use this constant to <code>getPreferredGap</code>.
	 */
	...
	/**
	 * Sets the LayoutStyle instance to use for this look and feel. You
	 * generally don't need to invoke this, instead use the getter which will
	 * return the LayoutStyle appropriate for the current look and feel.
	 * 
	 * @param layoutStyle
	 *            the LayoutStyle to use; a value of null indicates the default
	 *            should be used
	 */
	...
	/**
	 * For some look and feels check boxs and radio buttons have an empty border
	 * around them. Look and feel guidelines generally don't include this space.
	 * Use this method to subtract this space from the specified components.
	 * 
	 * @param source
	 *            First component
	 * @param target
