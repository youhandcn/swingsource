 ...
 */
public class MyColumnButtonListRenderer extends JButton implements
		ListCellRenderer {
	 ...
	 *            cell width.
	 */
	MyColumnButtonListRenderer(JTable table, JList list, int cellWidth) {
	 ...
	 *            the list .
	 */
	MyColumnButtonListRenderer(JTable table, JList list) {
		this(table, list, 100);
	}
